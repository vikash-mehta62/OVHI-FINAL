...
const generateEnhancedAIAssessment = async (
  ...
  const prompt = `You are a healthcare AI assistant conducting a comprehensive Patient Care Management (CCM) assessment. Analyze the patient data and assessment responses to provide a detailed clinical evaluation with risk stratification.
...
const generateProfessionalPDF2 = (
  ...
  const fileName = `${patient.firstName}_CCM_Assessment_${
  ...
  const generateAIAssessment = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `CCM assessment for ${patient.firstName} completed with ${response.riskLevel} risk level in ${calculatedTotalTime}.`,
      });
    } catch (error: any) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700 mt-1">
                    CCM Clinical Assessment for {patient?.firstName}
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center text-sm">
                  <div className="text-gray-600">
                    {patient?.firstName || "General Care"}
                  </div>
                </div>
              </div>
              <div>
      ...
      <Card className="border-2 border-blue-200">
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-2xl">
            ...
            <div>
              <div className="text-blue-800">CCM Clinical Assessment</div>
