-- Add Dummy Claims Data for Testing (Fixed Version)
...
-- Insert dummy patient profiles (only if they don't exist)
...
-- Insert 30 dummy claims data with various statuses and dates
...
-- Claims from 2-4 weeks ago (A/R aging 31-60 days)
...
-- Claims from 2-3 months ago (A/R aging 61-90 days)
(106, 1, 'CLM-2024-016', '96116', 'F32.1', 300.00, DATE_SUB(CURDATE(), INTERVAL 65 DAY), DATE_SUB(CURDATE(), INTERVAL 64 DAY), 1, 'Neurobehavioral exam - long pending', 'Aetna', DATE_SUB(NOW(), INTERVAL 65 DAY)),
(107, 1, 'CLM-2024-017', '96118', 'F41.9', 400.00, DATE_SUB(CURDATE(), INTERVAL 70 DAY), DATE_SUB(CURDATE(), INTERVAL 69 DAY), 3, 'Neuropsych testing - denied coding error', 'UnitedHealthcare', DATE_SUB(NOW(), INTERVAL 70 DAY)),
(108, 1, 'CLM-2024-018', '90791', 'F43.12', 250.00, DATE_SUB(CURDATE(), INTERVAL 75 DAY), DATE_SUB(CURDATE(), INTERVAL 74 DAY), 1, 'Psychiatric eval - awaiting appeal decision', 'Cigna', DATE_SUB(NOW(), INTERVAL 75 DAY)),
(109, 1, 'CLM-2024-019', '99213', 'F90.1', 150.00, DATE_SUB(CURDATE(), INTERVAL 80 DAY), DATE_SUB(CURDATE(), INTERVAL 79 DAY), 1, 'ADHD follow-up - insurance review', 'Humana', DATE_SUB(NOW(), INTERVAL 80 DAY)),
(110, 1, 'CLM-2024-020', '99214', 'F33.1', 200.00, DATE_SUB(CURDATE(), INTERVAL 85 DAY), DATE_SUB(CURDATE(), INTERVAL 84 DAY), 1, 'Depression management - under review', 'Medicare', DATE_SUB(NOW(), INTERVAL 85 DAY)),

-- Very old claims (120+ days) - Collections candidates
(101, 1, 'CLM-2024-021', '90834', 'F32.9', 120.00, DATE_SUB(CURDATE(), INTERVAL 125 DAY), DATE_SUB(CURDATE(), INTERVAL 124 DAY), 1, 'Old therapy claim - collections candidate', 'Medicaid', DATE_SUB(NOW(), INTERVAL 125 DAY)),
(102, 1, 'CLM-2024-022', '99215', 'F41.1', 250.00, DATE_SUB(CURDATE(), INTERVAL 130 DAY), DATE_SUB(CURDATE(), INTERVAL 129 DAY), 3, 'Anxiety treatment - final denial', 'Blue Cross Blue Shield', DATE_SUB(NOW(), INTERVAL 130 DAY)),
(103, 1, 'CLM-2024-023', '90837', 'F43.10', 160.00, DATE_SUB(CURDATE(), INTERVAL 135 DAY), DATE_SUB(CURDATE(), INTERVAL 134 DAY), 1, 'PTSD therapy - write-off candidate', 'Aetna', DATE_SUB(NOW(), INTERVAL 135 DAY)),
(104, 1, 'CLM-2024-024', '96116', 'F90.9', 300.00, DATE_SUB(CURDATE(), INTERVAL 140 DAY), DATE_SUB(CURDATE(), INTERVAL 139 DAY), 1, 'Neurobehavioral - patient responsibility', 'UnitedHealthcare', DATE_SUB(NOW(), INTERVAL 140 DAY)),
(105, 1, 'CLM-2024-025', '96118', 'F84.0', 400.00, DATE_SUB(CURDATE(), INTERVAL 145 DAY), DATE_SUB(CURDATE(), INTERVAL 144 DAY), 1, 'Neuropsych testing - collections referral', 'Cigna', DATE_SUB(NOW(), INTERVAL 145 DAY)),

-- Additional recent claims for better testing (reusing patient IDs)
(106, 1, 'CLM-2024-026', '90791', 'F32.1', 250.00, DATE_SUB(CURDATE(), INTERVAL 1 DAY), CURDATE(), 0, 'Psychiatric evaluation - just created', 'Humana', DATE_SUB(NOW(), INTERVAL 1 DAY)),
(107, 1, 'CLM-2024-027', '99213', 'F41.9', 150.00, DATE_SUB(CURDATE(), INTERVAL 8 DAY), DATE_SUB(CURDATE(), INTERVAL 7 DAY), 4, 'Anxiety follow-up - appealed', 'Medicare', DATE_SUB(NOW(), INTERVAL 8 DAY)),
(108, 1, 'CLM-2024-028', '99214', 'F43.12', 200.00, DATE_SUB(CURDATE(), INTERVAL 18 DAY), DATE_SUB(CURDATE(), INTERVAL 17 DAY), 2, 'PTSD management - paid', 'Medicaid', DATE_SUB(NOW(), INTERVAL 18 DAY)),
(109, 1, 'CLM-2024-029', '90834', 'F90.1', 120.00, DATE_SUB(CURDATE(), INTERVAL 22 DAY), DATE_SUB(CURDATE(), INTERVAL 21 DAY), 1, 'ADHD therapy - submitted', 'Blue Cross Blue Shield', DATE_SUB(NOW(), INTERVAL 22 DAY)),
(110, 1, 'CLM-2024-030', '90837', 'F33.1', 160.00, DATE_SUB(CURDATE(), INTERVAL 28 DAY), DATE_SUB(CURDATE(), INTERVAL 27 DAY), 2, 'Depression extended therapy - paid', 'Aetna', DATE_SUB(NOW(), INTERVAL 28 DAY));
