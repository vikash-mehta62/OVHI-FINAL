...
async function testDetailedClaimAPI() {
  try {
    ...
    try {
      ...
      const response = await axios.get('http://localhost:8000/api/v1/rcm/claims/1/detailed', { headers });
    ...
    try {
      ...
      const response = await axios.get('http://localhost:8000/api/v1/rcm/claims/1', { headers });
